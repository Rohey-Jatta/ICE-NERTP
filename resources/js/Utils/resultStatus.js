...
// NOTE ON COLORS: the app moved from a dark-theme workspace to a light-
// theme one (see resources/css/app.css "Workspace" section). The badge
// classes below previously used translucent dark-mode combos like
// `bg-amber-500/20 text-amber-300`, which render as near-invisible pale
// text on the current light/white panels. They have been switched to
// solid light-background + dark-text combos (the same pattern already
// used for the WS badges, e.g. `bg-amber-100 text-amber-800`) for proper
...
const STATUS_META = Object.freeze({
    ...
    [RESULT_STATUS.SUBMITTED]: {
        ...
        borderedBadgeClass: 'bg-sky-100 text-sky-700 border-sky-200',
        mapColor: '#f97316',
        icon: '📤',
    },
    [RESULT_STATUS.PENDING_PARTY_ACCEPTANCE]: {
        ...
        borderedBadgeClass: 'bg-amber-100 text-amber-800 border-amber-200',
        mapColor: '#f59e0b',
        icon: '⏳',
    },
    [RESULT_STATUS.PENDING_WARD]: {
    ...
    [RESULT_STATUS.CONSTITUENCY_CERTIFIED]: {
        ...
        borderedBadgeClass: 'bg-cyan-100 text-cyan-800 border-cyan-200',
        mapColor: '#06b6d4',
        icon: '✓',
    },
    ...
    [RESULT_STATUS.ADMIN_AREA_CERTIFIED]: {
        ...
        borderedBadgeClass: 'bg-violet-100 text-violet-800 border-violet-200',
        mapColor: '#14b8a6',
        icon: '✓',
    },
    [RESULT_STATUS.PENDING_NATIONAL]: {
        ...
        borderedBadgeClass: 'bg-pink-100 text-pink-800 border-pink-200',
        mapColor: '#6366f1',
        icon: '⏳',
    },
    [RESULT_STATUS.NATIONALLY_CERTIFIED]: {
        ...
        borderedBadgeClass: 'bg-green-100 text-green-800 border-green-200',
        mapColor: '#10b981',
        icon: '🏆',
    },
    [RESULT_STATUS.REJECTED]: {
        ...
        borderedBadgeClass: 'bg-red-100 text-red-800 border-red-200',
        mapColor: '#ef4444',
        icon: '✗',
    },
});
