                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-slate-600 mb-2 font-semibold">
                                    Select Election Monitor User
                                    <span className="text-slate-500 font-normal text-xs ml-2">(users with election-monitor role)</span>
                                </label>
                                <select
                                    value={data.user_id}
                                ...
                                <p className="text-slate-500 text-xs mt-1">
                                    ...
                                    and assign the <strong className="text-slate-600">election-monitor</strong> role.
                                </p>
                            </div>
