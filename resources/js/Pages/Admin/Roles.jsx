...
export default function Roles({ auth, roles = [] }) {
    const handleManagePermissions = (roleId) => {
        // navigate to permissions management page (route may be stubbed)
        router.visit(`/admin/roles/${roleId}/permissions`);
    };
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {roles.length > 0 ? (
                        ...
                        <div className="col-span-2 bg-slate-800/40 rounded-xl p-12 border border-pink-300/50 text-center">
