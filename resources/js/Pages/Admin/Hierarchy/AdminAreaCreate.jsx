    ...
    return (
        <AppLayout user={auth?.user}>
            <div className="container mx-auto px-4 py-8 max-w-2xl">
                <div className="mb-6">
                    <Link href="/admin/hierarchy/admin-areas" className="text-slate-500 hover:text-iec-navy text-sm mb-2 inline-block">
                        ← Back to dashboard
                    </Link>
                    <h1 className="text-3xl font-bold text-iec-navy">Register New Administrative Area</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {elections.length === 0 ? (
                                <div className="p-4 bg-amber-500/10 border border-amber-500/30 rounded-lg">
                                    <p className="text-amber-300 text-sm">
                                        ...
                                        <Link href="/admin/elections/create" className="underline text-iec-pink-600">Create one first</Link>.
                                    </p>
                                </div>
                            ) : (
                                <select
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                            />
                            <p className="text-slate-500 text-xs mt-1">A short unique code for this administrative area.</p>
