                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-slate-800/40 rounded-xl p-8 border border-slate-700/50">
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className="text-2xl">Ì∑≥Ô∏è</div>
                                    <div>
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className="text-2xl">ÌæØ</div>
                                    <div>
                    ...
                    <div className="bg-slate-800/40 rounded-xl p-8 border border-slate-700/50">
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className="text-2xl">Ì≥ú</div>
                                    <div>
                    ...
                    <div className="bg-slate-800/40 rounded-xl p-8 border border-slate-700/50">
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className="text-2xl">Ì≤ö</div>
                                    <div>
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className="text-2xl">Ì≤æ</div>
                                    <div>
