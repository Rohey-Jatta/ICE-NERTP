            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            ...
                            {adminArea?.name && (
                                <p className="text-iec-pink-800 mt-1 text-lg">{adminArea.name}</p>
                            )}
                        </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <div className="bg-white rounded-xl p-5 border border-slate-200">
                        <div className="text-3xl font-bold text-amber-800">{pendingResults || 0}</div>
                        <div className="text-slate-600 text-sm mt-1">Ready for Review</div>
                        <div className="text-slate-600 text-xs mt-0.5">Pending your decision</div>
                    </div>
                    <div className="bg-white rounded-xl p-5 border border-slate-200">
                        <div className="text-3xl font-bold text-iec-pink-800">{statistics?.approved || 0}</div>
                        <div className="text-slate-800 text-sm mt-1">Area Certified</div>
                        <div className="text-slate-800 text-xs mt-0.5">Sent to Chairman</div>
                    </div>
                    <div className="bg-white rounded-xl p-5 border border-slate-200">
                        <div className="text-3xl font-bold text-iec-pink-800">{awaitingBelow || 0}</div>
                        <div className="text-slate-800 text-sm mt-1">In Pipeline</div>
                        <div className="text-slate-800 text-xs mt-0.5">At ward/constituency level</div>
                    </div>
                    <div className="bg-white rounded-xl p-5 border border-slate-200">
                        <div className="text-3xl font-bold text-iec-navy">{statistics?.constituencies || 0}</div>
                        <div className="text-slate-800 text-sm mt-1">Constituencies</div>
                        <div className="text-slate-800 text-xs mt-0.5">In your area</div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        >
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-8 h-8 bg-amber-500/20 rounded-lg flex items-center justify-center text-amber-800">⏳</div>
                        ...
                        >
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-8 h-8 bg-iec-pink-500/20 rounded-lg flex items-center justify-center text-iec-pink-800">🗂</div>
                                <div className="text-lg font-bold text-iec-navy">Constituency Breakdowns</div>
                            </div>
                            <div className="text-iec-pink-800 text-sm">
                        ...
                        >
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-8 h-8 bg-iec-pink-50 rounded-lg flex items-center justify-center text-iec-pink-800">📊</div>
                                <div className="text-lg font-bold text-iec-navy">Analytics</div>
                            </div>
                            <div className="text-iec-pink-800 text-sm">Full admin-area statistics</div>
                        </Link>
                    </div>
                </div>
            </div>
